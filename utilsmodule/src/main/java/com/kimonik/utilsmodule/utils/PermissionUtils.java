...
public class PermissionUtils {
    ...
    private static final String[] permissionName = new String[]{
...
//            "android.permission.SYSTEM_ALERT_WINDOW",
    ...
    /**
     * 检测app运行时需要的权限是否已授予并返回未授权的权限名称
     */
    public static List<String> checkAPPNeedPermission(Context context) {
     ...
     * @return 是否已经获取权限
     */
    public static void requestPerssions(Activity activity, int requestCode, List<String> list) {
        if (list != null) {
    ...
    public static void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
        ...
        callBack.requestResult(requestCode, denied);
    }
    ...
    public interface OnRequestPermissionsResultCallbacks {
         ...
         * @param perms       未申请成功的授权
         */
        void requestResult(int requestCode, List<String> perms);
