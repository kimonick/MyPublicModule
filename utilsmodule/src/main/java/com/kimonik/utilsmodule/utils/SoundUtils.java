...
public class SoundUtils {
    ...
    private static final MediaPlayer.OnCompletionListener beepListener = new MediaPlayer
    ...
    public static void playSound(Context context, int rawId) {
        ...
        soundPool.load(context.getApplicationContext(), rawId, 1);
